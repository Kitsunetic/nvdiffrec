...
class DatasetMesh(Dataset):
    ...
    def _random_scene(self):
        ...
        proj_mtx = util.perspective(
            self.fovy, iter_res[1] / iter_res[0], self.FLAGS.cam_near_far[0], self.FLAGS.cam_near_far[1]
        )
    ...
    def __getitem__(self, itr):
        ...
        return {"mv": mv, "mvp": mvp, "campos": campos, "resolution": iter_res, "spp": iter_spp, "img": img}
